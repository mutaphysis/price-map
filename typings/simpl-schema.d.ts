declare module "simpl-schema" {
    ...
    type Integer = RegExp;
    type SchemaType = String | Number | Integer | Boolean | Object | Array<any> | SimpleSchemaStatic | Date;
    ...
    interface SimpleSchemaStatic {
        new(schema: {[key: string]: SchemaDefinition | SchemaType} | any[]): SimpleSchemaStatic;
        debug: boolean;
        ...
        oneOf(...schemas: {[key: string]: SchemaDefinition | SchemaType}[]): void;
        Integer: Integer;
        RegEx: {
            Email: RegExp;
            EmailWithTLD: RegExp;
